  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="flex items-center justify-center px-6 py-4">
        <img src={logo} alt="background" className="w-20 h-20" />
      </div>

      <div className={`bg-white rounded-t-3xl p-4`}>
        <div className="flex items-center justify-between mt-0 poppins-text mb-4">
          ...
          {brands.length === 0
            ...
            : brands.slice(0, 15).map((item) => (
                <div key={item?._id} className="min-w-[70px] mb-3">
                  <div
                    onClick={() =>
                      navigateWithParams("/bank/offers", { brand: item?._id })
                    }
